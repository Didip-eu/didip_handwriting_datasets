...
class CharClass():
    ...
    character_categories = {
        ...
        '5': '5', '6': '6', '7': '7', '8': '8', '9': '9',
        'A': 'AÁÂÃÄÅÆĂĄÀ',
        'a': 'aáâãäåæāăąàæ\u0363', # subscript 'a'
        'B': 'B',
        'b': 'b',
        'C': 'CÇĆĈĊČ',
        'c': 'cçćĉċč\u0368', # subscript 'c'
        'D': 'DÐĎĐ',
        'd': 'dðďđď\u0369', # subscript 'd'
        'E': 'EÈÉÊËĒĔĖĘĚ',
        'e': 'eèéêëēĕėęě\u0364', # subscript 'e'
        'F': 'F',
        'f': 'f',
        'G': 'GĜĞĠĢ',
        'g': 'gĝğġģḡ',
